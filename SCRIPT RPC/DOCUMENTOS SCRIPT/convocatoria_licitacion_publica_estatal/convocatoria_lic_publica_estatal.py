...
doc = DocxTemplate("/home/gerardo/Escritorio/SCRIPT RPC/DOCUMENTOS SCRIPT/convocatoria_licitacion_publica_estatal/Convocatoria_Licitacion_Publica_Estatal.DOCX")  # nuevo
for i in licitacion:
