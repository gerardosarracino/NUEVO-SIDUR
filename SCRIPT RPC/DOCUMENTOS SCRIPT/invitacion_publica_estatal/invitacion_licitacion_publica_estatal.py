...
doc = DocxTemplate("/home/gerardo/Escritorio/SCRIPT RPC/DOCUMENTOS SCRIPT/invitacion_publica_estatal/Invitación_Licitación_Pública_Estatal.DOCX")  # nuevo
for i in licitacion:
    ...
    for x in b_lic:
        ...
        fecha_oficio = str(x.fechaoficio2.day) + " de " + meses[x.fechaoficio2.month] + " del " + str(x.fechaoficio2.year)
        ...
        # f = time.strftime("%H:%M:%S", time.gmtime(x.visitafechahora.hour))
        # print(f)
