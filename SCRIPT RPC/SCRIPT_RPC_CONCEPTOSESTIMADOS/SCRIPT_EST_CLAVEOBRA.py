...
partidas = odoo.env['control.estimaciones'].search([]) # ('obra', '=', 'SIDUR-ED-20-014.2001')
...
for x in partidas:
    ...
    for i in b_estimaciones:
        ...
        datos = {
            'clave_obra': i.obra.obra.obra_planeada.numero_obra
        }
        print(i.obra.obra.obra_planeada.numero_obra)
        b_estimaciones.write(datos)
