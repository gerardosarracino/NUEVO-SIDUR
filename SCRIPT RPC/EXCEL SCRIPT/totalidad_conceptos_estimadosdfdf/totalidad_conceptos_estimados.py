...
partida = odoo.env['partidas.partidas'].search([('nombre_partida', '=', 'SIDUR-PF-18-220.1497')])
            ...
            for column in range(imporx, impory):
                ...
                for k in b_partida.conceptos_partidas:
                    ...
                    if str(clave) == 'SUBTOTAL':
                        ...
                        sheet[column_letter_subtimporte + str(acum_clavex + 9)].fill = PatternFill("solid", fgColor="04BDF4")
                    ...
                    if str(clave) == 'SUBTOTAL':
                        ...
                        if str(y.clave_linea) == str(clave):
                            ...
                            if estimacion_c == 1:
                                ...
                                sheet[column_letter + str(acum_clavex + 9)] = "=SUM(" + column_letterx + str(acum_clavex + 9) + "," + column_lettery + str(acum_clavex + 9) + continuacion + ")"
                                sheet[column_letter + str(acum_clavex + 9)].border = Border(top=thin, left=thin, right=thin, bottom=thin)
